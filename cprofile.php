                          ...
                          <div class="card-body media align-items-center">
                            ...
                            <div class="media-body ml-4">
                              <label class="btn btn-outline-primary">
                                Upload new photo
                                <input type="file" name="cimage" id="cimage" class="account-settings-fileinput">
                              </label> &nbsp;
...
<?php
$query2=mysqli_query($conn,"select * from users_contributor where usr_id ='".$ab_user[0]['usr_id']."'");
          ...
          ?>
                            ...
                            <div class="form-section-block">
                              ...
                              <div class="form-group">
                                ...
                                <input type="text" class="form-control" value="<?=$row2['usrc_give_to_community'];?>" name="gcommunity"
                                id="gcommunity">
                              </div>

                              <div class="form-group">
                                <label class="form-label">Proficiency</label>
                                <input type="text" class="form-control" value="<?=$row2['usrc_proficiency'];?>" name="proficiency" id="proficiency">
                              </div>

                              <div class="form-group">
                                <label class="form-label">Education Quaalification (University)</label>
                                <input type="text" class="form-control" value="<?=$row2['usrc_qualification_university'];?>" name="Quaalification" id="Quaalification">
                              </div>
...
<?php } ?>
                            ...
                            <div class="form-section-block">
                              <?php
$query3=mysqli_query($conn,"select * from users_contributor where usr_id ='".$ab_user[0]['usr_id']."'");
                        ...
                        <?php } ?>    
                              ...
                              <div class="form-group">
                                ...
                                <div class="row d-flex justify-content-center mt-100">
                                  <div class="col-md-12"> <select id="choices-multiple-remove-button" name="cinterest[]" placeholder="Select upto 5 tags" multiple>
                                    <?php $query1=mysqli_query($conn,"select * from tblinterest where usr_type ='C'");
...
<?php }
        ...
        //while($row4=mysqli_fetch_array($query4)){ 
          ?>
                                          <option value="<?=$row1['interest_id'];?>" ><?=$row1['interest_name'];?></option>
                                         <?php } 
        }
                                       ?>
...
<script type="text/javascript">
  $(document).ready(function(){
  $("#cprofile_form").submit(function(e) {
e.preventDefault();
//alert(1);
...
var newdata2 = new FormData(this);
  ...
  newdata2.append( "action", 'addcprofile');
$.ajax({
          url: "all_ajax.php",
          method: 'post',
          data: newdata2,
