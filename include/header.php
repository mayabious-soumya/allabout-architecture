                ...
                <div class="card">
                  <ul class="nav nav-tabs" role="tablist">
                    <li role="presentation" class="active">
                      <a href="#searchCategory" class="active show" aria-controls="searchCategory" role="tab" data-toggle="tab">
                        <span>Search by Category</span>
                      </a>
                    </li>

                    <li role="presentation">
                      <a href="#searchProduct" aria-controls="searchProduct" role="tab" data-toggle="tab">
                  ...
                  <div class="tab-content">
                    <div role="tabpanel" class="tab-pane active" id="searchCategory">
                    ...
                    <div role="tabpanel" class="tab-pane" id="searchProduct">
                      <!-----product--->
                      <div class="row">
