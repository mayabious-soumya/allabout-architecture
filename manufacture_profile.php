        ...
        <div class="container">
          <!---
            ...
            <div class="profile-block">
              ...
              <div class="container1 light-style flex-grow-1 container-p-y">
                          ...
                          <div class="card-body">
                            ...
                            <div class="form-section-block">
                              ...
                              <div class="form-row">
                                <div class="form-group col-sm-6">
                                  ...
                                  <input type="text" class="form-control mb-1" value="Manufacturer">
                                </div>
                                <div class="form-group col-sm-6">
                                  <label class="form-label">Company Name *</label>
                                  <input type="text" class="form-control mb-1" value="Company Name">
                                </div>                                
                              </div>

                              <div class="form-group">
                                <label class="form-label">About Organisation</label>
                                <input type="text" class="form-control mb-1" value="About Organisation">
                              </div>

                              <div class="form-row">
                                <div class="form-group col-sm-6">
                                  <label class="form-label">Genre</label>
                                  <input type="text" class="form-control mb-1" value="Genre">
                                </div>
                                <div class="form-group col-sm-6">
                                  <label class="form-label">Establishment (years)</label>
                                  <input type="text" class="form-control mb-1" value="years">
                                </div>                                
                              </div>
                              ...
                              <div class="form-row">
                                <div class="form-group col-sm-6">
                                  ...
                                  <input type="text" class="form-control mb-1" value="Full Name">
                                </div>
                                <div class="form-group col-sm-6">
                                  <label class="form-label">Contact Person Details</label>
                                  <input type="text" class="form-control mb-1" value="Details">
                                </div>                                
                              </div>
                              ...
                              <div class="form-row">
                                <div class="form-group col-sm-6">
                                  ...
                                  <input type="text" class="form-control mb-1" value="Employee">
                                </div>
                                <div class="form-group col-sm-6">
                                  <label class="form-label">Last year Turnover</label>
                                  <input type="text" class="form-control mb-1" value="Ammount">
                                </div>                                
                              </div>
                            </div>
                            ...
                            <div class="form-section-block">
                              ...
                              <div class="form-group">
                                ...
                                <input type="text" class="form-control" value="Trade Licence">
                              </div>

                              <div class="form-group">
                                <label class="form-label">GST Certificate (If available)</label>
                                <input type="text" class="form-control" value="GST Number">
                              </div>
